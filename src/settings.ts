...
class Settings {
  ...
  public get numTeams():      number { return Number(this.inpTeams.value); }
  public get gridSize():      number { return Number(this.inpSize.value);  }
  public get ticksPerFrame(): number { return Number(this.inpSpeed.value); }
